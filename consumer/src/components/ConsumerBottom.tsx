                            ...
                            <DrawerHeader className="p-6 pb-4 relative border-b border-white/10 shrink-0">
                                ...
                                <div className="flex items-center gap-3">
                                    <button onClick={() => setSheetOpen(false)}
                                            className="p-2 -ml-2 hover:bg-white/10 rounded-full transition-colors shrink-0 cursor-pointer">
                                                ...
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div className="flex flex-col">
                                                        ...
                                                        <div className="flex items-center gap-1.5 mt-0.5">
                                                            <span
                                                                className="text-[12px] text-white/50">{poi.type === 'stamp' ? 'AR Collectible' : poi.type === 'gate' ? 'Entrance' : 'Point of Interest'}</span>
                                                            {(poi as any).distance && (
                                                                <>
                                                                    <span className="text-[10px] text-white/20">•</span>
                                                                    <span
                                                                        className="text-[12px] text-emerald-400/80 font-medium">{Math.round((poi as any).distance)}m away</span>
                                                                </>
                                                            )}
                                                            {poi.tags?.includes('paid') && (
                                                                <>
                                                                    <span className="text-[10px] text-white/20">•</span>
                                                                    <span
                                                                        className="text-[11px] font-bold text-amber-400">₹ Paid</span>
                                                                </>
                                                            )}
                                                        </div>
                                                    </div>
